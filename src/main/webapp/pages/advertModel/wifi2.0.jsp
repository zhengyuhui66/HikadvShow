...
<body class="gray-bg bgimage">
			<div id="wifi2" style="height: 200px;border-radius: 20px;text-align:center;margin:0px 20px 0px 20px;
			background-repeat:no-repeat;
			background-size:cover;" advertidwifi2="">
	...
	<script>
		...
		if (!materurlwifi2) {
			...
			$("#wifi2").css('background-repeat', "no-repeat");
			$("#wifi3").css('background-size', "cover");
		}
