...
<body class="gray-bg bgimage"  id="wifibgId">
			<div  style="text-align:center;">
				<img id="wifi2" src="" width='30%' height='400' style="float:left;"/>
				<h1 class="logo-name" id="wifiId" style="display:inline;position:absolute;right:0;left:0;">
					<i class="fa fa-wifi wificolor" style="margin-top:20px;"></i>
				</h1>
				<img id="wifi1" src="" width='30%' height='400' style="float:right;"/>
			</div>
			<div class="middle-box text-center loginscreen  animated fadeInDown" style="position:absolute;bottom:0px;right:10px;left:10px;">
...
<div class="modal fade" id="exampleModal" tabindex="1000" role="dialog"  aria-hidden="true" data-backdrop="static" aria-labelledby="exampleModalLabel">
	...
	<script>
		...
		if(materurlwifi1){
			$("#wifi1").css('display','inline');
			$("#wifi1").attr('src',materurlwifi1);
		}else{
			$("#wifi1").css('display','none');			
		}
