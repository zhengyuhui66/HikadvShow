...
<body class="gray-bg">
	<div class="middle-box text-center loginscreen  animated fadeInDown">
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"  aria-hidden="true" data-backdrop="static"
			...
			<div class="modal-dialog" role="document"  style="width:330px;height:245px;">
				<div class="modal-content" align="center" >
					<h4 style="margin-top:20px;">协议条款:</h4>
					<div style="margin-top: 20px;width:310px;height:245px;overflow-y:auto;" align="left">
						<ol>
	...
	<script>
		$('#exampleModal').modal();
		var t51 =<%=request.getParameter("materurlwifi1")%>;
		var t52 =<%=request.getParameter("materurlwifi2")%>;
		if (!t52) {
			$("#wifiId").css('display', 'inline');
		} else {
			$("#wifiId").css('display', 'none');
			$("#wifi2").css('background-image', "url('" + t52 + "')");
		}
		if(t51){
			$("#wifi1").css('background-image', "url('" + t51 + "')");			
		}
	</script>
</body>
</html>
