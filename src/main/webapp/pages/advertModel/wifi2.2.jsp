...
<body id="wifibg" class="gray-bg" style="padding-top:80%;">
<!-- <div  style='background-color:#453324;height:100%;'> -->
			<div  style="padding-top:0px;" class="middle-box text-center loginscreen  animated fadeInDown">
				...
				<form class="m-t" role="form" onsubmit="return toVaild()"
					...
					<div class="form-group">
						...
						<input id="Code" name="Code" type="text" class="form-control"
							...
							<span class="input-group-btn">
								<button type="submit" class="btn btn-style btn-sm btn-sendsms"
										id="authId">点击认证</button>
							</span>
						</input>
						</div>
					</div>
			...
			<div class="modal-dialog" role="document"  style="width:330px;height:245px;margin:10px auto;">
				<div class="modal-content" align="center" >
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-style" data-dismiss="modal">同意</button>
