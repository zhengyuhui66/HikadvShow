...
<body class="gray-bg bgimage">
			<div style="height: 200px;border-radius: 20px;text-align:center;margin:0px 0px 0px 0px;">
				<img  id="wifi2" width="300" height="200" src=''></img>
...
// 		showcount(advertid,modelmodelid,modelid)
